...
function buildLwWheelTab() {
  ...
  var rows = _order.map(function(i) {
    ...
    return '<tr class="lw-row tl-dnd-row" id="lw-card-' + i + '" data-secidx="' + i + '"'
      ...
      + '<td style="white-space:nowrap;"><span style="font-size:var(--fs-base);font-weight:' + (sec.status === 'concern' ? '700' : '400') + ';color:var(--text-1);">' + statusInfo.label + '</span></td>'
...
function lwOpenSectionModal(idx) {
  ...
  var html = '<div class="lw-modal-overlay" id="lw-modal-overlay" onclick="lwModalOverlayClick(event)">'
    ...
    + '<label style="font-size:var(--fs-sm);font-weight:700;color:var(--text-1);">Emoji</label>'
    + '<input id="lw-modal-emoji" type="text" value="' + hwEsc(sec.emoji || '') + '" maxlength="4"'
    + ' style="width:52px;text-align:center;font-size:20px;border:1.5px solid var(--border);border-radius:7px;background:transparent;color:var(--text-1);padding:4px;">'
    + '</div>'
    + '<div style="flex:1;display:flex;flex-direction:column;gap:4px;">'
    + '<label style="font-size:var(--fs-sm);font-weight:700;color:var(--text-1);">Section</label>'
    + '<input id="lw-modal-name" type="text" value="' + hwEsc(sec.name || '') + '"'
    + ' style="width:100%;border:1.5px solid var(--border);border-radius:7px;background:transparent;color:var(--text-1);padding:7px 10px;font-size:13px;font-family:inherit;box-sizing:border-box;">'
    + '</div>'
    + '<div style="display:flex;flex-direction:column;gap:4px;">'
    + '<label style="font-size:var(--fs-sm);font-weight:700;color:var(--text-1);">Color</label>'
    ...
    + ' style="width:38px;height:38px;padding:2px;border:1.5px solid var(--border);border-radius:7px;background:transparent;cursor:pointer;flex-shrink:0;">'
    ...
    + ' style="width:84px;border:1.5px solid var(--border);border-radius:7px;background:transparent;color:var(--text-1);padding:7px 8px;font-size:13px;font-family:inherit;box-sizing:border-box;text-transform:uppercase;">'
    + '</div>'
    + '</div></div>'
