...
function htEmptyHtml(year) {
  return '<div class="ht-empty">'
    ...
    + '<div class="ht-empty-desc">Mandalart 의 실행항목을 <b>습관형</b>(일간 · 주간)으로 지정하면<br>여기에서 한 해 실적을 관리할 수 있습니다.</div>'
...
function htListHtml(year, habits, cur) {
  ...
  var rows = habits.map(function(h) {
    ...
    var freq = (a.habitFreq === 'weekly') ? ('주 ' + Math.max(1, +a.habitWeeklyTarget || 1) + '회') : '매일';
